  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        ...
        className="w-full rounded-[2px] bg-accent hover:bg-accent-hover active:bg-accent-hover disabled:opacity-50 text-white font-medium py-2.5 transition-colors"
      >
